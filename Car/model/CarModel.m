...
- (void) encodeWithCoder:(NSCoder *)aCoder{
    ...
    [aCoder encodeInteger:_carTypeId forKey:@"carTypeId"];
    [aCoder encodeObject:_carTypeName forKey:@"carTypeName"];
}
...
- (instancetype) initWithCoder:(NSCoder *)aDecoder{
    if (self = [super init]){
        ...
        self.carTypeId = [aDecoder decodeIntegerForKey:@"carTypeId"];
